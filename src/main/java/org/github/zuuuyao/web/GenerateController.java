...
public class GenerateController extends BaseController {
    ...
    public ResponseEntity<byte[]> codeGeneration(@RequestBody @Validated CodeGenerateInputDTO inputDTO) {
        return generateService.codeGeneration(inputDTO, super.getResponse());
    }
}
